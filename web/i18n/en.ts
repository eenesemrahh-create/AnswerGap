...
export const en = {
  ...
  detail: {
    ...
    aiUnreadable: "Google answers this question with an AI Overview, but it loads after the page and its sources could not be read. Whether anyone is cited here is unknown.",
