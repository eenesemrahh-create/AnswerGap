...
export const de: Messages = {
  ...
  auth: {
    ...
    deleteTitle: "Mein Konto lÃ¶schen",
    deleteLead: "Das lÃ¤sst sich nicht rÃ¼ckgÃ¤ngig machen. Deine Suchen werden von dir gelÃ¶st; deine E-Mail-Adresse und deine Zahlungsbelege bleiben.",
    deleteAction: "Mein Konto lÃ¶schenâ¦",
    deleteConfirmTitle: "Dieses Konto lÃ¶schen?",
    deleteRemoves: "Entfernt: dein Name, dein Bild, dein Passwort, deine gespeicherten Einstellungen und die Verbindung zwischen dir und jeder Suche. Deine gespeicherten Analysen gehÃ¶ren dir dann nicht mehr.",
    deleteKeeps: "Behalten: deine E-Mail-Adresse, damit wir dich bei einer RÃ¼ckkehr wiedererkennen, und deine Zahlungsbelege, die wir steuerlich aufbewahren mÃ¼ssen.",
    deleteRevives: "Meldest du dich mit dieser Adresse erneut an, kommt das Konto zurÃ¼ck und bezahlte Credits sind noch da. Die Suchen nicht.",
    deleteConfirmPassword: "Zum BestÃ¤tigen dein Passwort eingeben",
    deleteConfirmEmail: "Zum BestÃ¤tigen {email} eingeben",
    deleteSubmit: "Mein Konto lÃ¶schen",
