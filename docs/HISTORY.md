# AnswerGap - history and reference

The second half of `CLAUDE.md`, split off on 2026-09-19 because the single
file had reached ~155 KB. `CLAUDE.md` keeps the rules, the current state and
the Next list; everything here is dated engineering log or reference, read on
demand. Sections are verbatim and in their original order. "Above" / "below"
in a section may point into the other file.
